            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="artupload.php">Upload Art</a>
                        </li><li class="nav-item">
                            <a class="nav-link" aria-current="page" href="postjob.php">Post Job</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="findajob.php">Find a Job</a>
                        </li>
